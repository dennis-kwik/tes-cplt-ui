...
4. Referensi desain UI — Chameleon Angular Framework demo: https://demo.silkroad-app.com/chameleon-angular-framework (FALLBACK: hanya dipakai untuk redraw manual jika Code Interpreter/embed image tidak tersedia di environment agent; default sekarang embed file gambar asli, lihat 03.4 & 17).
